...
namespace Uplift.DataAccess.Data.Initializer
{
    public class DBInitializer : IDBInitializer
    {
        ...
        public void Initialize()
        {
            ...
            _userManager.CreateAsync(new ApplicationUser //IdentityUser //ApplicationUser can be used..
            {
            ...
            //ApplicationUser user = _db.ApplicationUser.Where(u => u.Email.Equals("admin@gmail.com")).FirstOrDefault();
            ApplicationUser user = _db.ApplicationUser
                .FromSqlRaw("Select * from dbo.aspnetusers where email = 'admin@gmail.com' ")
                .FirstOrDefault();
